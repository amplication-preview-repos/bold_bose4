...
import { LegalDocumentListRelationFilter } from "../../legalDocument/base/LegalDocumentListRelationFilter";
...
class BusinessWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => LegalDocumentListRelationFilter,
  })
  @ValidateNested()
  @Type(() => LegalDocumentListRelationFilter)
  @IsOptional()
  @Field(() => LegalDocumentListRelationFilter, {
    nullable: true,
  })
