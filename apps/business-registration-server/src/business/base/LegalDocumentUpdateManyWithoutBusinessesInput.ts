...
@InputType()
class LegalDocumentUpdateManyWithoutBusinessesInput {
...
export { LegalDocumentUpdateManyWithoutBusinessesInput as LegalDocumentUpdateManyWithoutBusinessesInput };
